...
class SceneLoader:
    ...
    def __init__(
        ...
        self._back_up_dict = back_up_dict
    ...
    def get_scene_from_token(self, token: str) -> Scene:
        ...
        return Scene.from_scene_dict_list(
            ...
            back_up_dict=self._back_up_dict,
        )
    ...
    def get_tokens_list_per_log(self) -> Dict[str, List[str]]:
        ...
        return tokens_per_logs# log可以看作是场景吗？还是？
...
class MetricCacheLoader:
    ...
    def _load_metric_cache_paths(self, cache_path: Path) -> Dict[str, Path]:
        ...
        """
        # metadata_dir = cache_path / metadata_dir_sub if metadata_dir_sub is None else metadata_dir_sub
        metadata_dir = cache_path.parent / "metadata" / cache_path.name
        metadata_dir = Path(metadata_dir)
        # print("[DEBUG]",metadata_dir)
