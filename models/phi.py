...
class PhiForCausalLM(PhiPreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        depth_encoder_forward: Optional[nn.Module] = None,
        input_ids_for_match:Optional[torch.LongTensor] = None,
        ...
        outputs = self.model(
            input_ids=input_ids,
            attention_mask=attention_mask,#(batch,1,L，L）
            position_ids=position_ids,
        ...
        hidden_states = outputs[0]#(特征维度2048)
        if depth_encoder_forward:
            hidden_states = depth_encoder_forward.residula_net_forward(inputs_embeds,input_ids_for_match,hidden_states)
